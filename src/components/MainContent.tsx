...
const MainContent: React.FC = () => {
  return (
    <main className="flex-grow p-8 min-w-0 bg-gray-900">
      <h1 className="text-4xl font-bold mb-8 text-center text-gray-100">Title Portion</h1>
      <div className="bg-gray-800 p-6 rounded shadow-lg mb-8">
        <p className="text-gray-300">
          Dynamic Content Placeholder. Here, we'll display information related to the main theme of the page.
        </p>
      </div>
